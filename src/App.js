...
//  合约地址
const MYNFT_ADDRESS = "0xf658f264eC1d20C5b4Be1Bac77F0e33D6D12C777";
const MARKET_ADDRESS = "0xBeE5f3D7e01d3A035d41bEC04C25A47392c78641";
    ...
    <div className="App">
      ...
      {!account ? (
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="输入 Token CID"
            value={tokenCID}
            onChange={(e) => setTokenCID(e.target.value)}
          />
          <button onClick={mintNFT} disabled={loading}>
            {loading ? 'Minting...' : '铸造 NFT'}
          </button>
